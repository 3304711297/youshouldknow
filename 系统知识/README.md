...
- [排查阻止 Windows 自动睡眠的程序](./排查阻止Windows自动睡眠的程序.md) — 旧路径兼容入口（已并入电源主文）
...
以下文件的详细内容已并入主文，旧路径保留用于兼容历史链接：

- [Windows 优化前准备与风险等级](./Windows优化前准备与风险等级.md) → [系统调优与安全/Windows优化原则与风险](../系统调优与安全/Windows优化原则与风险.md)
- [Windows 优化误区](./Windows优化误区.md) → [系统调优与安全/Windows优化原则与风险](../系统调优与安全/Windows优化原则与风险.md)
- [排查阻止 Windows 自动睡眠的程序](./排查阻止Windows自动睡眠的程序.md) → [电源计划创建与优化指南](./电源计划创建与优化指南.md)
