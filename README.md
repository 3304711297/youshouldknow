...
| **🔌 BIOS 与固件** | 共 26 篇文章：BIOS 选项科普系列 23 篇（含重制版第一季 21 篇及第二季 EP01/EP02 PBO 与四面墙篇；Secure Boot、TPM、PBO、PPT/TDC/EDC 功耗电流墙等，逐篇附出处；XMP/EXPO 篇在「内存超频」分类），另有 3 篇专题：固件刷写与开机 Logo 修改、UEFI Editor、移动端笔记本 BIOS 选项与超频降压安全边界 |
...
```text
youshouldknow/
├─ docs/                                  # 全部文章，14 个分类目录（共 117 篇文章；AI 工具 26 篇、BIOS 与固件 25 篇、系统知识 17 篇等），各分类另有 README 索引
