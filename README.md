...
| **🔌 BIOS 与固件** | 共 25 篇文章：BIOS 选项科普系列 22 篇（含重制版第一季 21 篇及第二季 EP01 PBO 基础篇；Secure Boot、TPM、PBO、功耗墙等，逐篇附出处；XMP/EXPO 篇在「内存超频」分类），另有 3 篇专题：固件刷写与开机 Logo 修改、UEFI Editor、移动端笔记本 BIOS 选项与超频降压安全边界 |
