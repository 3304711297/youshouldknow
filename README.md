...
| **🔌 BIOS 与固件** | 共 29 篇文章：BIOS 选项科普系列 25 篇（含系列总览与重制版第一季、第二季 EP01–EP03 的 PBO 与四面墙篇；Secure Boot、TPM、PBO、PPT/TDC/EDC 功耗电流墙等，逐篇附出处；XMP/EXPO 篇在「内存超频」分类），另有 4 篇专题：固件刷写与开机 Logo 修改、UEFI Editor、同方模具解锁 BIOS 全功能菜单（AMITSE 与 AMIBCP 路线）、移动端笔记本 BIOS 选项与超频降压安全边界 |
...
```text
youshouldknow/
├─ docs/                                  # 全部文章，14 个分类目录（共 131 篇文章；BIOS 与固件 29 篇、AI 工具 28 篇、系统知识 19 篇等），各分类另有 README 索引
