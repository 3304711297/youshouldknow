...
>
> ⚠️ 本文为个人/社区作业笔记整理，未经独立横向验证；两组数据的内部换算自洽性已核对，见[事实核查记录](#fact-check)。同平台英睿达（Micron C8D/M8D1）2×16G 的作业另见 [i7-12800HX 英睿达超频参数](./i7-12800HX英睿达C8D-M8D1超频参数.md)。
...
> 变体的取舍逻辑：以放宽 tRCD/tRP（40→42）为代价，换取 tCL（40→38）与 tRAS（77→55）的收紧——典型的 CL 优先权衡。注意该表未包含电压部分。
...
核验基准：原始笔记截图（来自荣耀笔记 App）+ 内部换算自洽性检验（2026-08-29 重核：个案实机记录，不适用其他平台；换算复核无误——tRFC≈258/295ns、tRFCpb≈135/130ns、tRFC2≈180/160ns，阅读说明的变体边界（仅 tCL 38 / tRCD·tRP 42 / tRAS 55 三行）与表格一致）。
