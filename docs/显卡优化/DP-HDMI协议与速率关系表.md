...
| --- | --- | --- | --- |
| DP 1.0 / 1.1 | RBR / HBR | 6.48 / 10.8 Gbps | 最高 2560×1600 |
...
> 子版本数字（10/13.5/20）即每通道链路速率，×4 通道得总带宽。⚠️ 勘误（2026-09-12 重核 VESA 规范）：UHBR10/13.5/20 三档在 DP 2.0（2019 规范）即已全部定义；DP 2.1 的主要变化是新增 **DP40 / DP80 线缆认证**。
...
| UHBR13.5 为 DP 2.1 新增档位 | ❌ 勘误（2026-09-12）：DP 2.0（2019）即定义 UHBR10/13.5/20 三档；DP 2.1 新增的是 DP40/DP80 线缆认证 |
